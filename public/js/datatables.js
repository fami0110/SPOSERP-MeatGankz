    ...
    return function t(e, s, i) {
                    ...
                    var i = e((function (t, e) {
                        t.exports = function () {
                            ...
                            var C = function () {
                                ...
                                return p.parse = function (t) {
                                    ...
                                    ,
                                    p.$set = function (n, h) {
                                        var d, c = w.p(n), u = "set" + (this.$u ? "UTC" : ""), p = (d = {},
                                            d[a] = u + "Date",
                                            d[l] = u + "Date",
                                            d[r] = u + "Month",
                                            d[o] = u + "FullYear",
                                    ...
                                    p.diff = function (t, l, d) {
                                        var c, u = w.p(l), p = v(t), f = 6e4 * (p.utcOffset() - this.utcOffset()), g = this - p, m = w.m(this, p);
                                        return m = (c = {},
                                            c[o] = m / 12,
                                            c[r] = m,
                                            c[h] = m / 3,
                            ...
                            return v.prototype = x,
                                [["$ms", t], ["$s", e], ["$m", s], ["$H", i], ["$W", a], ["$M", r], ["$y", o], ["$D", l]].forEach((function (t) {
                                    x[t[1]] = function (e) {
                        ...
                        , a = e((function (t, e) {
                            ...
                            t.exports = (s = {
                                ...
                                ,
                                a = /(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,
                                o = {},
                                d = [/[+-]\d\d:?(\d\d)?/, function (t) {
                                    ...
                                    i.parse = function (t) {
                                        ...
                                        if ("string" == typeof r) {
                                            ...
                                            l && (c = n[2]),
                                                ...
                                                d && e !== this.format(r) && (this.$d = new Date("")),
                                                o = {}
        ...
        2: [function (t, e, s) {
                ...
                order(t) {
                    ...
                    t.forEach(((t, i) => {
                        n = l.headings[t],
                            ...
                            e.sortable = r,
                            o[0].push(e),
                            l.hiddenColumns.includes(t) || (s = n.cloneNode(!0),
                            ...
                            i = e.cloneNode(!1),
                                ...
                                t.forEach((t => {
                                    h = e.cells[t].cloneNode(!0),
                                        ...
                                        i.appendChild(h),
                                        l.hiddenColumns.includes(t) || (h = e.cells[t].cloneNode(!0),
                                            h.data = e.cells[t].data,
                                            a.appendChild(h))
                                }
                                )),
                ...
                add(t) {
                    ...
                    this.dt.hiddenHeader ? s.innerHTML = "" : t.heading.nodeName ? s.appendChild(t.heading) : s.innerHTML = t.heading,
                        ...
                        this.dt.data.forEach(((s, i) => {
                            t.data[i] && (e = document.createElement("td"),
                    ...
                    Promise.all(p).then((t => {
                        ...
                        Array.from(r).forEach((t => {
                            ...
                            "desc" == s ? (p = h(o, -1),
                                ...
                                u.classList.add("desc")) : (p = h(l, 1),
                                    f = h(o, 1),
                                    u.classList.remove("desc"),
                                    u.classList.add("asc")),
                            a.lastTh && u != a.lastTh && (a.lastTh.classList.remove("desc"),
            ...
            const d = function (t) {
                ...
                t.data && t.data.length && (s = a("tbody"),
                    t.data.forEach((e => {
            ...
            class u {
                ...
                render(t) {
                    ...
                    if (this.headings = [],
                        ...
                        e.footer ? this.head && !this.foot && (this.foot = a("tfoot", {
                ...
                renderPage() {
                    ...
                    let t, e = 0, s = 0, i = 0;
                    if (this.totalPages && (e = this.currentPage - 1,
                ...
                renderPager() {
                    if (n(this.pagers),
                        ...
                        this.options.firstLast && e.appendChild(r(t, 1, this.options.firstText)),
                            this.options.nextPrev && e.appendChild(r(t, s, this.options.prevText));
                        let n = this.links;
                        this.options.truncatePager && (n = ((t, e, s, i, n) => {
                            ...
                            this.links[this.currentPage - 1].classList.add("active"),
                            this.options.nextPrev && e.appendChild(r(t, i, this.options.nextText)),
                ...
                fixColumns() {
                    if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                        ...
                        if (this.columnWidths = [],
                            this.table.tHead) {
                            if (this.options.scrollY.length && (e = a("thead"),
                                e.appendChild(a("tr")),
                                e.style.height = "0px",
                ...
                clear(t) {
                    ...
                    this.body || (e = this.table),
                        t && ("string" == typeof t && (document.createDocumentFragment().innerHTML = t),
                            e.appendChild(t))
                }
                export(t) {
                    ...
                    if (l.type) {
                        if ("txt" !== l.type && "csv" !== l.type || (s[0] = this.header),
                            l.selection)
                        ...
                        if (s.length) {
                            if ("txt" === l.type || "csv" === l.type) {
                                    ...
                                    for (r = 0; r < s[n].cells.length; r++)
                                        if (!l.skipColumn.includes(e[r].originalCellIndex) && this.columns(e[r].originalCellIndex).visible()) {
                                            ...
                                            t = t.trim(),
                                                ...
                                                t = t.replace(/#/g, "%23"),
                                                t.includes(",") && (t = `"${t}"`),
                                                h += t + l.columnDelimiter
                                        }
                                    h = h.trim().substring(0, h.length - 1),
                                        h += l.lineDelimiter
                                }
                                h = h.trim().substring(0, h.length - 1),
                                    l.download && (h = "data:text/csv;charset=utf-8," + h)
                            } else if ("sql" === l.type) {
                                for (h = `INSERT INTO \`${l.tableName}\` (`,
                                    n = 0; n < e.length; n++)
                                    !l.skipColumn.includes(e[n].originalCellIndex) && this.columns(e[n].originalCellIndex).visible() && (h += `\`${e[n].textContent}\`,`);
                                for (h = h.trim().substring(0, h.length - 1),
                                    h += ") VALUES ",
                                    n = 0; n < s.length; n++) {
                                    for (h += "(",
                                        r = 0; r < s[n].cells.length; r++)
                                        !l.skipColumn.includes(e[r].originalCellIndex) && this.columns(e[r].originalCellIndex).visible() && (h += `"${s[n].cells[r].textContent}",`);
                                    h = h.trim().substring(0, h.length - 1),
                                        h += "),"
                                }
                                h = h.trim().substring(0, h.length - 1),
                                    h += ";",
                                    l.download && (h = "data:application/sql;charset=utf-8," + h)
                            } else if ("json" === l.type) {
                                ...
                                h = JSON.stringify(a, l.replacer, l.space),
                                    l.download && (h = "data:application/json;charset=utf-8," + h)
                            }
                            return l.download && (l.filename = l.filename || "datatable_export",
                                l.filename += "." + l.type,
                                h = encodeURI(h),
