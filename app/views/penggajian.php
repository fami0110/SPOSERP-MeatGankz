...
<?php if ($data['user']): ?>
                  ...
                  <div class="panel-title">
                    <div class="row">
                      ...
                      <div class="col-md-2 text-end">
                        <h6> <button class="btn btn-outline-primary" data-bs-toggle="modal"
                            data-bs-target="#modalGaji">Tambah Data</button></h6>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <table id="table" class="table table-sm table-bordered table-hover text-nowrap" style="width:100%">
                      <thead>
                        <tr>
                          <th rowspan="2" class="align-middle">No.</th>
                          <th rowspan="2" class="align-middle">Nomor Pengawai</th>
                          <th rowspan="2" class="align-middle">Nama</th>
                          <th rowspan="2" class="align-middle">Jabatan</th>
                          <th rowspan="2" class="align-middle">Surat Peringatan</th>
                          <th colspan="5" class="text-center">Gaji</th>
                          <th rowspan="2" class="align-middle">Gaji Total</th>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-center">
                            <button class="btn bg-gradient-primary rounded-pill btn-icon"  data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fa fa-pen"></i></button>
                            <button class="btn btn-danger rounded-pill btn-icon delete-button"  data-toggle="tooltip" data-placement="bottom" title="Hapus"><i class="fa fa-trash"></i></button>
                            <button class="btn bg-gradient-dark rounded-pill btn-icon" data-toggle="tooltip" data-placement="bottom" title="Print Slip Gaji" data-bs-toggle="modal" data-bs-target="#modalSlipGaji"><i class="fa fa-print"></i></button>
                          </td>
                        </tr>
                      </tbody>
                    </table>
      ...
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
                    ...
                    <div class="col-md-10">
                      <div class="card border-1 shadow-none rounded-2 mb-2">
                        <div class="card-body p-1 px-2">
                          <div class="row">
                            <div class="col-md-6">
                              <input type="text" class="form-control ps-2 border-start my-1" placeholder="Surat Peringatan 1"
                                aria-label="suratPeringatan1" id="suratPeringatan1" name="suratPeringatan1"
                                aria-describedby="suratPeringatan1" readonly>
                            </div>
                            <div class="col-md-6">
                              <div class="input-group my-1">
                                <span class="input-group-text">Rp.</span>
                                <input type="number" class="form-control ps-2 border-start gaji-input" placeholder="0" aria-label="potonganSuratPeringatan1"
                                  id="potonganSuratPeringatan1" name="potonganSuratPeringatan1" aria-describedby="potonganSuratPeringatan1">
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="col-md-10">
                      <div class="card border-1 shadow-none rounded-2 mb-2">
                        <div class="card-body p-1 px-2">
                          <div class="row">
                            <div class="col-md-6">
                              <input type="text" class="form-control ps-2 border-start my-1" placeholder="Surat Peringatan 2"
                                aria-label="suratPeringatan2" id="suratPeringatan2" name="suratPeringatan2"
                                aria-describedby="suratPeringatan2" readonly>
                            </div>
                            <div class="col-md-6">
                              <div class="input-group my-1">
                                <span class="input-group-text">Rp.</span>
                                <input type="number" class="form-control ps-2 border-start gaji-input" placeholder="0" aria-label="potonganSuratPeringatan2"
                                  id="potonganSuratPeringatan2" name="potonganSuratPeringatan2" aria-describedby="potonganSuratPeringatan2">
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-10">
                      <div class="input-group mb-3">
                        <span class="input-group-text">Rp.</span>
                        <input type="number" class="form-control ps-2 border-start" placeholder="0" aria-label="gajiPokok"
                          id="gajiPokok" name="gajiPokok" aria-describedby="gajiPokok" readonly>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="form-group col-md-3">
                      ...
                      <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">Rp.</span>
                        <input type="number" class="form-control ps-2 border-start gaji-input" placeholder="200.000 (Input angka saja)"
                          aria-label="gajiTunjangan" id="gajiTunjangan" name="gajiTunjangan"
                          aria-describedby="basic-addon1">
                      </div>
                    </div>
        ...
        <!-- Modal Slip Gaji -->
        <div class="modal fade" id="modalSlipGaji" data-bs-backdrop="static"
          data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <!-- End Modal -->
                    ...
                    <script src="<?= BASEURL; ?>/js/penggajian.js"></script>
                    <script>
                        $(function() {
