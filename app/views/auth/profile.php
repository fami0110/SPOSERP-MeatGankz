          ...
          <div class="row">
            <div class="col-6">
              ...
              <div class="input-group">
                <input id="firstName" name="firstName" class="form-control" type="text" value=" <?= $data['user']['username'] ?>" required="required">
              </div>
            </div>
            <div class="col-6">
              <label class="form-label">Email</label>
              <div class="input-group">
                <input id="lastName" name="lastName" class="form-control" type="text" value=" <?= $data['user']['email'] ?>" required="required">
              </div>
            </div>
          </div>
          <div class="row mt-3">
            <div class="col-6">
              ...
              <div class="input-group">
                <input id="lastName" name="lastName" class="form-control" type="text" value=" <?= $data['user']['role'] ?>" required="required">
              </div>
            </div>
            <div class="col-6">
              <label class="form-label">Last Login</label>
              <div class="input-group">
                <input id="lastName" name="lastName" class="form-control" type="text" value=" <?= $data['user']['last_login_at'] ?>" required="required">
              </div>
            </div>
          </div>
        </div>
